/*
  # Fix Row-Level Security policies for stores table
  ...
  1. Security Updates
    ...
    - Add debugging function to test auth.uid()
  ...
  3. Debugging
    - Add function to test auth.uid() functionality
    - Add comprehensive logging for policy debugging
*/
